...
impl OnionClient {
    ...
    fn send_dht_pk_onion(&self, friend: &mut OnionFriend, paths_pool: &mut PathsPool) -> Vec<(DhtPacket, SocketAddr)> {
    ...
    fn send_dht_pk_dht_request(&self, friend: &mut OnionFriend) -> Vec<(DhtPacket, SocketAddr)> {
